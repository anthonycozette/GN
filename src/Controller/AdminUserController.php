...
class AdminUserController extends AbstractController
{
    ...
    public function edit(Request $request, User $user, $role): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $userForData = $request->request->get("user"); // on recupere les donnees du formulaire poste dans un tableau
            $roleToCheck = $userForData["role"]; // on recupere la valeur du choiceType de la propriete $role dans le formulaire
            ...
            // on flush pour mettre a jour la BDD
